...
public class PaymentTransaction {
    @nu3("data")
    @qy0
    private ArrayList<PaymentTransactionsItem> data;
    @nu3("description")
    @qy0
    ...
    public PaymentTransaction(String str, String str2, String str3, ArrayList<PaymentTransactionsItem> arrayList) {
        this.message = str;
    ...
    public ArrayList<PaymentTransactionsItem> getData() {
        return this.data;
    }
    ...
    public void setData(ArrayList<PaymentTransactionsItem> arrayList) {
        this.data = arrayList;
    }
