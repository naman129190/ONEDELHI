...
public class mm1 {
    ...
    /* renamed from: a */
    public static final int f32179a = 10000;

    /* renamed from: b */
    public static final int f32180b = 8192;

    /* renamed from: b */
    public static final String f32181b = "GET";

    /* renamed from: a */
    public final String f32182a;

    /* renamed from: a */
    public final Map<String, String> f32183a;

    /* renamed from: b */
    public final Map<String, String> f32184b = new HashMap();

    public mm1(String str, Map<String, String> map) {
        this.f32182a = str;
        this.f32183a = map;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:6:0x0040, code lost:
        r1 = r7.next();
        r0.append(com.onedelhi.secure.a13.f25714b);
        r0.append((java.lang.String) r1.getKey());
        r0.append(com.onedelhi.secure.a13.f25713a);
     */
    ...
    public final java.lang.String mo40694a(java.util.Map<java.lang.String, java.lang.String> r7) throws java.io.UnsupportedEncodingException {
        /*
            r6 = this;
        ...
        L_0x005e:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.onedelhi.secure.mm1.mo40694a(java.util.Map):java.lang.String");
    }

    /* renamed from: b */
    public final String mo40695b(String str, Map<String, String> map) throws UnsupportedEncodingException {
        String a = mo40694a(map);
        if (a.isEmpty()) {
            return str;
        }
        if (str.contains("?")) {
            if (!str.endsWith(a13.f25714b)) {
                a = a13.f25714b + a;
            }
            return str + a;
        }
    ...
    /* renamed from: c */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public com.onedelhi.secure.ym1 mo40696c() throws java.io.IOException {
        /*
            r5 = this;
            r0 = 0
            java.lang.String r1 = r5.f32182a     // Catch:{ all -> 0x0084 }
            java.util.Map<java.lang.String, java.lang.String> r2 = r5.f32183a     // Catch:{ all -> 0x0084 }
            java.lang.String r1 = r5.mo40695b(r1, r2)     // Catch:{ all -> 0x0084 }
            com.onedelhi.secure.o92 r2 = com.onedelhi.secure.o92.m59120f()     // Catch:{ all -> 0x0084 }
            ...
            r2.mo41621k(r3)     // Catch:{ all -> 0x0084 }
            ...
            java.util.Map<java.lang.String, java.lang.String> r2 = r5.f32184b     // Catch:{ all -> 0x0082 }
        ...
        L_0x005f:
            ...
            java.lang.String r0 = r5.mo40699f(r3)     // Catch:{ all -> 0x0071 }
            goto L_0x0074
        L_0x0071:
            r2 = move-exception
            r0 = r3
        ...
        L_0x0079:
            r1.disconnect()
            com.onedelhi.secure.ym1 r1 = new com.onedelhi.secure.ym1
            r1.<init>(r2, r0)
            return r1
        L_0x0082:
            r2 = move-exception
        ...
        L_0x0090:
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.onedelhi.secure.mm1.mo40696c():com.onedelhi.secure.ym1");
    }

    /* renamed from: d */
    public mm1 mo40697d(String str, String str2) {
        this.f32184b.put(str, str2);
        return this;
    }

    /* renamed from: e */
    public mm1 mo40698e(Map.Entry<String, String> entry) {
        return mo40697d(entry.getKey(), entry.getValue());
    }

    /* renamed from: f */
    public final String mo40699f(InputStream inputStream) throws IOException {
