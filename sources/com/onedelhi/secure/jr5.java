...
public enum jr5 {
    ...
    /* renamed from: a */
    public static final jr5 m18774a(@ts2 String str) {
        for (jr5 jr5 : values()) {
            if (jr5.f14439b.equals(str)) {
                return jr5;
            }
        }
        return UNKNOWN;
    ...
    @ShowFirstParty
    /* renamed from: b */
    public static boolean m18775b(jr5 jr5) {
        return BAD_AUTHENTICATION.equals(jr5) || CAPTCHA.equals(jr5) || NEED_PERMISSION.equals(jr5) || NEED_REMOTE_CONSENT.equals(jr5) || NEEDS_BROWSER.equals(jr5) || USER_CANCEL.equals(jr5) || DEVICE_MANAGEMENT_REQUIRED.equals(jr5) || DM_INTERNAL_ERROR.equals(jr5) || DM_SYNC_DISABLED.equals(jr5) || DM_ADMIN_BLOCKED.equals(jr5) || DM_ADMIN_PENDING_APPROVAL.equals(jr5) || DM_STALE_SYNC_REQUIRED.equals(jr5) || DM_DEACTIVATED.equals(jr5) || DM_REQUIRED.equals(jr5) || THIRD_PARTY_DEVICE_MANAGEMENT_REQUIRED.equals(jr5) || DM_SCREENLOCK_REQUIRED.equals(jr5);
    }
}
