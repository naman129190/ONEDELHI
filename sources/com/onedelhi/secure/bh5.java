...
@VisibleForTesting
public final class bh5 implements p44 {

    /* renamed from: a */
    public final Fragment f9825a;

    /* renamed from: a */
    public final ao1 f9826a;

    public bh5(Fragment fragment, ao1 ao1) {
        this.f9826a = (ao1) Preconditions.checkNotNull(ao1);
        this.f9825a = (Fragment) Preconditions.checkNotNull(fragment);
    }
    ...
    public final void mo13628a(Activity activity, Bundle bundle, @ts2 Bundle bundle2) {
        try {
            ...
            this.f9826a.mo13210S2(nt2.m23166l8(activity), (StreetViewPanoramaOptions) null, bundle3);
    ...
    public final void mo13704i(fv2 fv2) {
        try {
            this.f9826a.mo13216f0(new tg5(this, fv2));
        } catch (RemoteException e) {
            throw new qo3(e);
        }
    }
    ...
    public final View mo13637k(LayoutInflater layoutInflater, @ts2 ViewGroup viewGroup, @ts2 Bundle bundle) {
        try {
            Bundle bundle2 = new Bundle();
            us5.m29561b(bundle, bundle2);
            tn1 Y = this.f9826a.mo13211Y(nt2.m23166l8(layoutInflater), nt2.m23166l8(viewGroup), bundle2);
            us5.m29561b(bundle2, bundle);
