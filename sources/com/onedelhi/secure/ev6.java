...
public final class ev6 {
    ...
    /* renamed from: a */
    public static final bv6 f11731a = new cv6();

    static {
        if (zu6.m33451C() && zu6.m33452D()) {
            int i = tl6.f20961a;
        }
    }

    /* renamed from: a */
    public static /* bridge */ /* synthetic */ int m14400a(byte[] bArr, int i, int i2) {
        int i3 = i2 - i;
        byte b = bArr[i - 1];
        if (i3 != 0) {
            if (i3 == 1) {
    ...
    public static int m14401b(java.lang.CharSequence r7, byte[] r8, int r9, int r10) {
        /*
            int r0 = r7.length()
            r1 = 0
        L_0x0005:
        ...
        L_0x00bb:
            r1 = r4
        L_0x00bc:
            com.onedelhi.secure.dv6 r7 = new com.onedelhi.secure.dv6
            int r1 = r1 + -1
            r7.<init>(r1, r0)
            throw r7
        L_0x00c4:
        ...
        L_0x00ff:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.onedelhi.secure.ev6.m14401b(java.lang.CharSequence, byte[], int, int):int");
    }

    /* renamed from: c */
    public static int m14402c(CharSequence charSequence) {
        ...
        throw new IllegalArgumentException("UTF-8 length does not fit in int: " + (((long) i3) + C1655a7.C1658c.f8859a));
    }

    /* renamed from: d */
    public static boolean m14403d(byte[] bArr) {
        return f11731a.mo13835b(bArr, 0, bArr.length);
    }

    /* renamed from: e */
    public static boolean m14404e(byte[] bArr, int i, int i2) {
        return f11731a.mo13835b(bArr, i, i2);
    }
}
