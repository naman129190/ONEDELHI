...
public final class dh5 {
    ...
    public static void m13125a(com.onedelhi.secure.a56 r10, android.database.sqlite.SQLiteDatabase r11, java.lang.String r12, java.lang.String r13, java.lang.String r14, java.lang.String[] r15) throws android.database.sqlite.SQLiteException {
        /*
        ...
        L_0x002a:
            ...
            r2 = r1
        L_0x002d:
            com.onedelhi.secure.u46 r4 = r10.mo12731w()     // Catch:{ all -> 0x00d8 }
            java.lang.String r5 = "Error querying for table"
            r4.mo25381c(r5, r12, r3)     // Catch:{ all -> 0x00d8 }
        ...
        L_0x00b2:
            ...
            com.onedelhi.secure.u46 r11 = r10.mo12731w()     // Catch:{ SQLiteException -> 0x00cd }
            ...
            r11.mo25381c(r14, r12, r13)     // Catch:{ SQLiteException -> 0x00cd }
        L_0x00c7:
            return
        L_0x00c8:
            r11 = move-exception
        ...
        L_0x00e0:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.onedelhi.secure.dh5.m13125a(com.onedelhi.secure.a56, android.database.sqlite.SQLiteDatabase, java.lang.String, java.lang.String, java.lang.String, java.lang.String[]):void");
    }

    /* renamed from: b */
    public static void m13126b(a56 a56, SQLiteDatabase sQLiteDatabase) {
        if (a56 != null) {
            File file = new File(sQLiteDatabase.getPath());
            if (!file.setReadable(false, false)) {
                a56.mo12731w().mo25379a("Failed to turn off database read permission");
            }
            if (!file.setWritable(false, false)) {
                a56.mo12731w().mo25379a("Failed to turn off database write permission");
            }
            if (!file.setReadable(true, true)) {
                a56.mo12731w().mo25379a("Failed to turn on database read permission for owner");
            }
            if (!file.setWritable(true, true)) {
                a56.mo12731w().mo25379a("Failed to turn on database write permission for owner");
                return;
            }
            return;
        }
