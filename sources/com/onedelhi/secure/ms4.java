...
public class ms4 extends dl3 {

    /* renamed from: a */
    public static final int f16278a = 20;

    /* renamed from: a */
    public static boolean f16279a = false;

    /* renamed from: a */
    public final WeakReference<Context> f16280a;

    public ms4(@mr2 Context context, @mr2 Resources resources) {
        super(resources);
        this.f16280a = new WeakReference<>(context);
    }

    /* renamed from: b */
    public static boolean m21937b() {
        return f16279a;
    }

    /* renamed from: c */
    public static void m21938c(boolean z) {
        f16279a = z;
    }

    /* renamed from: d */
    public static boolean m21939d() {
        boolean b = m21937b();
        return false;
    }
    ...
    public Drawable getDrawable(int i) throws Resources.NotFoundException {
        Context context = (Context) this.f16280a.get();
        return context != null ? sk3.m27673h().mo24469t(context, this, i) : mo14742a(i);
    }
