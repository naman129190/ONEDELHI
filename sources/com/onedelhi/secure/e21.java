...
public final class e21 {
    ...
    /* renamed from: b */
    public static String m45851b(int i, int i2, String str) throws tr2 {
        if (str.length() >= i) {
            String substring = str.substring(0, i);
            int i3 = i2 + i;
            if (str.length() >= i3) {
                String substring2 = str.substring(i, i3);
                String str2 = pl2.f33726c + substring + ')' + substring2;
                String a = m45850a(str.substring(i3));
                if (a == null) {
                    return str2;
                }
                return str2 + a;
    ...
    /* renamed from: c */
    public static String m45852c(int i, int i2, String str) throws tr2 {
        String substring = str.substring(0, i);
        int min = Math.min(str.length(), i2 + i);
        String substring2 = str.substring(i, min);
        String str2 = pl2.f33726c + substring + ')' + substring2;
        String a = m45850a(str.substring(min));
        if (a == null) {
            return str2;
        }
        return str2 + a;
