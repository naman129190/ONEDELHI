...
public final class fv5 {
    ...
    /* renamed from: a */
    public static volatile cz5 f12358a;
    ...
    public static com.onedelhi.secure.cz5 m15346a(android.content.Context r14) {
        /*
            java.lang.Class<com.onedelhi.secure.fv5> r0 = com.onedelhi.secure.fv5.class
            monitor-enter(r0)
            com.onedelhi.secure.cz5 r1 = f12358a     // Catch:{ all -> 0x0174 }
        ...
        L_0x001b:
            ...
            goto L_0x0033
        L_0x002c:
            com.onedelhi.secure.cz5 r14 = com.onedelhi.secure.cz5.m12865c()     // Catch:{ all -> 0x0174 }
        L_0x0030:
            r1 = r14
            goto L_0x016a
        L_0x0033:
            boolean r1 = com.onedelhi.secure.ft5.m15295b()     // Catch:{ all -> 0x0174 }
        ...
        L_0x0043:
            ...
            com.onedelhi.secure.cz5 r3 = com.onedelhi.secure.cz5.m12866d(r3)     // Catch:{ all -> 0x016d }
            goto L_0x0071
        L_0x0063:
            com.onedelhi.secure.cz5 r3 = com.onedelhi.secure.cz5.m12865c()     // Catch:{ all -> 0x016d }
            goto L_0x0071
        L_0x0068:
            r3 = move-exception
            ...
            goto L_0x0063
        L_0x0071:
            boolean r4 = r3.mo14444b()     // Catch:{ all -> 0x016d }
            if (r4 == 0) goto L_0x0161
            java.lang.Object r3 = r3.mo14443a()     // Catch:{ all -> 0x016d }
        ...
        L_0x010b:
            ...
            com.onedelhi.secure.du5 r14 = new com.onedelhi.secure.du5     // Catch:{ all -> 0x013e }
            r14.<init>(r6)     // Catch:{ all -> 0x013e }
            r4.close()     // Catch:{ IOException -> 0x015a }
            com.onedelhi.secure.cz5 r14 = com.onedelhi.secure.cz5.m12866d(r14)     // Catch:{ all -> 0x016d }
            goto L_0x0165
        L_0x013e:
            r14 = move-exception
        ...
        L_0x0161:
            com.onedelhi.secure.cz5 r14 = com.onedelhi.secure.cz5.m12865c()     // Catch:{ all -> 0x016d }
        L_0x0165:
            android.os.StrictMode.setThreadPolicy(r1)     // Catch:{ all -> 0x0174 }
            goto L_0x0030
        L_0x016a:
            f12358a = r1     // Catch:{ all -> 0x0174 }
            goto L_0x0172
        L_0x016d:
            r14 = move-exception
            android.os.StrictMode.setThreadPolicy(r1)     // Catch:{ all -> 0x0174 }
        ...
        L_0x0174:
            ...
            throw r14
        */
        throw new UnsupportedOperationException("Method not decompiled: com.onedelhi.secure.fv5.m15346a(android.content.Context):com.onedelhi.secure.cz5");
    }
}
