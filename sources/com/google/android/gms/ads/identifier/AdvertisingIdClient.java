...
import com.onedelhi.secure.m66;
import com.onedelhi.secure.mm0;
import com.onedelhi.secure.mr2;
import com.onedelhi.secure.q26;
...
public class AdvertisingIdClient {
    ...
    public static final class Info {
        ...
        @Deprecated
        public Info(@ts2 String str, boolean z) {
            this.zza = str;
            this.zzb = z;
        }
    ...
    @KeepForSdk
    public AdvertisingIdClient(@mr2 Context context) {
        this(context, 30000, false, false);
    }

    @VisibleForTesting
    public AdvertisingIdClient(@mr2 Context context, long j, boolean z, boolean z2) {
    ...
    @mr2
    @KeepForSdk
    public static Info getAdvertisingIdInfo(@mr2 Context context) throws IOException, IllegalStateException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
    ...
    @KeepForSdk
    public static boolean getIsAdIdFakeForDebugLogging(@mr2 Context context) throws IOException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        boolean s;
        ...
        try {
            ...
            synchronized (advertisingIdClient) {
                ...
                s = advertisingIdClient.zzb.mo20135s();
            }
    ...
    private final Info zzd(int i) throws IOException {
        ...
        synchronized (this) {
            ...
            info = new Info(this.zzb.mo20136w7(), this.zzb.mo20134P2(true));
        }
        zze();
        return info;
    }
        ...
        synchronized (this) {
            ...
            try {
                ...
                if (ConnectionTracker.getInstance().bindService(context, intent, blockingServiceConnection, 1)) {
                    ...
                    this.zzb = q26.m25265j8(blockingServiceConnection.getServiceWithTimeout(10000, TimeUnit.MILLISECONDS));
                    this.zzc = true;
                    if (z) {
                        zze();
                    }
    ...
    @VisibleForTesting
    public final boolean zzc(@ts2 Info info, boolean z, float f, long j, String str, @ts2 Throwable th) {
        if (Math.random() > 0.0d) {
            return false;
        }
        HashMap hashMap = new HashMap();
        String str2 = mm0.f16219f;
