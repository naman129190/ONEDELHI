...
public class GooglePlayServicesUtilLight {
    ...
    @KeepForSdk
    @Deprecated
    public static void cancelAvailabilityErrorNotifications(@mr2 Context context) {
        if (!sCanceledAvailabilityNotification.getAndSet(true)) {
            try {
                NotificationManager notificationManager = (NotificationManager) context.getSystemService(C4321e.f25157b);
    ...
    @KeepForSdk
    @Deprecated
    public static void ensurePlayServicesAvailable(@mr2 Context context, int i) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
    ...
    @KeepForSdk
    @Deprecated
    public static int getApkVersion(@mr2 Context context) {
        try {
    ...
    @KeepForSdk
    @Deprecated
    public static int getClientVersion(@mr2 Context context) {
        Preconditions.checkState(true);
        return ClientLibraryUtils.getClientVersion(context, context.getPackageName());
    }

    @vq1(imports = {"com.google.android.gms.common.GoogleApiAvailabilityLight"}, replacement = "GoogleApiAvailabilityLight.getInstance().getErrorResolutionPendingIntent(context, errorCode, requestCode)")
    @KeepForSdk
    @ts2
    @Deprecated
    ...
    @ShowFirstParty
    @vq1(imports = {"com.google.android.gms.common.GoogleApiAvailabilityLight"}, replacement = "GoogleApiAvailabilityLight.getInstance().getErrorResolutionIntent(null, errorCode, null)")
    @KeepForSdk
    @ts2
    @Deprecated
    ...
    @ShowFirstParty
    @KeepForSdk
    public static boolean honorsDebugCertificates(@mr2 Context context) {
        if (!zza) {
            try {
    ...
    public static int isGooglePlayServicesAvailable(@com.onedelhi.secure.mr2 android.content.Context r10, int r11) {
        /*
            java.lang.String r0 = "GooglePlayServicesUtil"
            android.content.res.Resources r1 = r10.getResources()     // Catch:{ all -> 0x000c }
            int r2 = com.google.android.gms.common.C1410R.string.common_google_play_services_unknown_issue     // Catch:{ all -> 0x000c }
    ...
    @KeepForSdk
    @Deprecated
    @vq1(imports = {"com.google.android.gms.common.util.UidVerifier"}, replacement = "UidVerifier.isGooglePlayServicesUid(context, uid)")
    ...
    @KeepForSdk
    @Deprecated
    public static boolean isPlayServicesPossiblyUpdating(@mr2 Context context, int i) {
        if (i == 18) {
            return true;
        }
        if (i == 1) {
    ...
    @KeepForSdk
    @Deprecated
    public static boolean isPlayStorePossiblyUpdating(@mr2 Context context, int i) {
        if (i == 9) {
    ...
    @TargetApi(18)
    @KeepForSdk
    public static boolean isRestrictedUserProfile(@mr2 Context context) {
        ...
        return applicationRestrictions != null && h60.f29487F.equals(applicationRestrictions.getString("restricted_profile"));
    }

    @ShowFirstParty
    @vq1(imports = {"com.google.android.gms.common.util.DeviceProperties"}, replacement = "DeviceProperties.isSidewinder(context)")
    @KeepForSdk
    @Deprecated
    @VisibleForTesting
    public static boolean isSidewinderDevice(@mr2 Context context) {
    ...
    @vq1(imports = {"com.google.android.gms.common.util.UidVerifier"}, replacement = "UidVerifier.uidHasPackageName(context, uid, packageName)")
    @TargetApi(19)
    @KeepForSdk
    @Deprecated
