...
import com.onedelhi.secure.x45;
...
public final class zae extends zag {
    ...
    public final void zaa(@ts2 Drawable drawable, boolean z, boolean z2, boolean z3) {
        ImageView imageView = (ImageView) this.zac.get();
        if (imageView == null) {
            return;
        }
        if (z2 || z3 || !(imageView instanceof zal)) {
            ...
            if (z4) {
                ...
                if (drawable2 == null) {
                    drawable2 = null;
                } else if (drawable2 instanceof x45) {
                    drawable2 = ((x45) drawable2).mo26775a();
                }
                drawable = new x45(drawable2, drawable);
            }
