...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getUrl", mo10053id = 2)
    private final Uri zab;
    @SafeParcelable.Field(getter = "getWidth", mo10053id = 3)
    private final int zac;
    @SafeParcelable.Field(getter = "getHeight", mo10053id = 4)
    private final int zad;

    @SafeParcelable.Constructor
    public WebImage(@SafeParcelable.Param(mo10056id = 1) int i, @SafeParcelable.Param(mo10056id = 2) Uri uri, @SafeParcelable.Param(mo10056id = 3) int i2, @SafeParcelable.Param(mo10056id = 4) int i3) {
        this.zaa = i;
        this.zab = uri;
        this.zac = i2;
        this.zad = i3;
    ...
    public WebImage(@mr2 Uri uri) throws IllegalArgumentException {
        this(uri, 0, 0);
    }

    public WebImage(@mr2 Uri uri, int i, int i2) throws IllegalArgumentException {
        this(1, uri, i, i2);
        if (uri == null) {
    ...
    public WebImage(@com.onedelhi.secure.mr2 org.json.JSONObject r5) throws java.lang.IllegalArgumentException {
        /*
            r4 = this;
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            jSONObject.put(yz1.f38148j, this.zac);
