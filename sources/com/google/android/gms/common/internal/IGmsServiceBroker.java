...
public interface IGmsServiceBroker extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGmsServiceBroker {
        ...
        public final boolean onTransact(int r4, @com.onedelhi.secure.mr2 android.os.Parcel r5, @com.onedelhi.secure.ts2 android.os.Parcel r6, int r7) throws android.os.RemoteException {
            /*
                r3 = this;
    ...
    @KeepForSdk
    void getService(@mr2 IGmsCallbacks iGmsCallbacks, @ts2 GetServiceRequest getServiceRequest) throws RemoteException;
}
