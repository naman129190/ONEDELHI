...
public abstract class BasePendingResult<R extends Result> extends PendingResult<R> {
    ...
    @VisibleForTesting
    public static class CallbackHandler<R extends Result> extends h55 {
        public CallbackHandler() {
            super(Looper.getMainLooper());
        }

        public CallbackHandler(@mr2 Looper looper) {
            super(looper);
        }

        public final void handleMessage(@mr2 Message message) {
            int i = message.what;
            if (i == 1) {
        ...
        public final void zaa(@mr2 ResultCallback resultCallback, @mr2 Result result) {
    ...
    @KeepForSdk
    @Deprecated
    public BasePendingResult(@mr2 Looper looper) {
        this.zae = new Object();
        this.zaf = new CountDownLatch(1);
        this.zag = new ArrayList();
        this.zai = new AtomicReference();
    ...
    @KeepForSdk
    public BasePendingResult(@ts2 GoogleApiClient googleApiClient) {
        this.zae = new Object();
        this.zaf = new CountDownLatch(1);
        this.zag = new ArrayList();
        this.zai = new AtomicReference();
    ...
    @KeepForSdk
    @VisibleForTesting
    public BasePendingResult(@mr2 CallbackHandler<R> callbackHandler) {
        this.zae = new Object();
        this.zaf = new CountDownLatch(1);
        this.zag = new ArrayList();
        this.zai = new AtomicReference();
    ...
    public static void zal(@ts2 Result result) {
    ...
    @mr2
    @KeepForSdk
    public abstract R createFailedResult(@mr2 Status status);

    @KeepForSdk
    @Deprecated
    public final void forceFailureUnlessReady(@mr2 Status status) {
        synchronized (this.zae) {
            if (!isReady()) {
    ...
    @KeepForSdk
    public final void setCancelToken(@mr2 ICancelToken iCancelToken) {
        synchronized (this.zae) {
    ...
    @KeepForSdk
    public final void setResult(@mr2 R r) {
        synchronized (this.zae) {
    ...
    @com.google.android.gms.common.annotation.KeepForSdk
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void setResultCallback(@com.onedelhi.secure.ts2 com.google.android.gms.common.api.ResultCallback<? super R> r5) {
        /*
            r4 = this;
    ...
    @com.google.android.gms.common.annotation.KeepForSdk
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void setResultCallback(@com.onedelhi.secure.mr2 com.google.android.gms.common.api.ResultCallback<? super R> r5, long r6, @com.onedelhi.secure.mr2 java.util.concurrent.TimeUnit r8) {
        /*
            r4 = this;
            java.lang.Object r0 = r4.zae
            monitor-enter(r0)
    ...
    public final void zan(@ts2 zadb zadb) {
        this.zai.set(zadb);
    }
}
