...
public final class zabq implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zau {
    ...
    @ts2
    @ly4
    private final Feature zaB(@ts2 Feature[] featureArr) {
        if (!(featureArr == null || featureArr.length == 0)) {
            Feature[] availableFeatures = this.zac.getAvailableFeatures();
            if (availableFeatures == null) {
                availableFeatures = new Feature[0];
            }
            C3042oa oaVar = new C3042oa(r3);
            for (Feature feature : availableFeatures) {
                oaVar.put(feature.getName(), Long.valueOf(feature.getVersion()));
            }
            for (Feature feature2 : featureArr) {
                Long l = (Long) oaVar.get(feature2.getName());
    ...
    @ly4
    private final void zaE(@ts2 Status status, @ts2 Exception exc, boolean z) {
        Preconditions.checkHandlerThread(this.zaa.zat);
        boolean z2 = false;
    ...
    public final void zaG() {
        ...
        while (it.hasNext()) {
            ...
            if (zaB(zaci.zaa.getRequiredFeatures()) == null) {
                try {
                    zaci.zaa.registerListener(this.zac, new x94());
    ...
    private final boolean zaM(@com.onedelhi.secure.mr2 com.google.android.gms.common.ConnectionResult r4) {
        /*
            r3 = this;
    ...
    public final void zao() {
        ...
        if (!this.zac.isConnected() && !this.zac.isConnecting()) {
            try {
                ...
                if (zab2 != 0) {
                    ConnectionResult connectionResult2 = new ConnectionResult(zab2, (PendingIntent) null);
                    String name = this.zac.getClass().getName();
                    String obj = connectionResult2.toString();
                    Log.w("GoogleApiManager", "The service for " + name + " is not available: " + obj);
                    zar(connectionResult2, (Exception) null);
                    return;
                }
                GoogleApiManager googleApiManager2 = this.zaa;
    ...
    @ly4
    public final void zar(@mr2 ConnectionResult connectionResult, @ts2 Exception exc) {
        Preconditions.checkHandlerThread(this.zaa.zat);
        zact zact = this.zai;
        if (zact != null) {
            zact.zaf();
        ...
        if ((this.zac instanceof zap) && connectionResult.getErrorCode() != 24) {
            this.zaa.zah = true;
            GoogleApiManager googleApiManager = this.zaa;
            googleApiManager.zat.sendMessageDelayed(googleApiManager.zat.obtainMessage(19), np1.f32709a);
        }
    ...
    @ly4
    public final void zas(@mr2 ConnectionResult connectionResult) {
        Preconditions.checkHandlerThread(this.zaa.zat);
        Api.Client client = this.zac;
