...
public final class SignInButton extends FrameLayout implements View.OnClickListener {
    ...
    public SignInButton(@mr2 Context context) {
        this(context, (AttributeSet) null);
    }

    public SignInButton(@mr2 Context context, @ts2 AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    /* JADX INFO: finally extract failed */
    public SignInButton(@mr2 Context context, @ts2 AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        this.zad = null;
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, uc3.C3699f.SignInButton, 0, 0);
        try {
            this.zaa = obtainStyledAttributes.getInt(uc3.C3699f.SignInButton_buttonSize, 0);
            this.zab = obtainStyledAttributes.getInt(uc3.C3699f.SignInButton_colorScheme, 2);
    ...
    @Deprecated
    public void setScopes(@mr2 Scope[] scopeArr) {
        setStyle(this.zaa, this.zab);
    }
    ...
    @Deprecated
    public void setStyle(int i, int i2, @mr2 Scope[] scopeArr) {
        setStyle(i, i2);
    }
}
