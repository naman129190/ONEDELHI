...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView implements bf4, ps0, ef4 {

    /* renamed from: a */
    public static final int[] f1334a = {16843126};

    /* renamed from: a */
    public final C1765b8 f1335a;
    @mr2

    /* renamed from: a */
    public final C2480j8 f1336a;

    /* renamed from: a */
    public final C3569t8 f1337a;

    public AppCompatAutoCompleteTextView(@mr2 Context context) {
        this(context, (AttributeSet) null);
    }

    public AppCompatAutoCompleteTextView(@mr2 Context context, @ts2 AttributeSet attributeSet) {
        this(context, attributeSet, za3.C4057b.autoCompleteTextViewStyle);
    }

    public AppCompatAutoCompleteTextView(@mr2 Context context, @ts2 AttributeSet attributeSet, int i) {
        super(xe4.m31415b(context), attributeSet, i);
        qb4.m25632a(this, getContext());
        af4 G = af4.m11110G(getContext(), attributeSet, f1334a, i, 0);
        if (G.mo13026C(0)) {
    ...
    /* renamed from: a */
    public void mo1711a(C2480j8 j8Var) {
    ...
    public boolean mo1712c() {
        return this.f1336a.mo18160c();
    }

    public void drawableStateChanged() {
        super.drawableStateChanged();
        C1765b8 b8Var = this.f1335a;
        if (b8Var != null) {
            b8Var.mo13520b();
        }
        C3569t8 t8Var = this.f1337a;
        if (t8Var != null) {
            t8Var.mo24746b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f1337a.mo24753j();
    }

    @ts2
    @hl3({hl3.C2354a.f13188c})
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f1337a.mo24754k();
    }

    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f1336a.mo18162e(C2701l8.m20260a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setEmojiCompatEnabled(boolean z) {
        this.f1336a.mo18163f(z);
    }

    public void setKeyListener(@ts2 KeyListener keyListener) {
        super.setKeyListener(this.f1336a.mo18158a(keyListener));
    }
    ...
    public void setSupportCompoundDrawablesTintList(@ts2 ColorStateList colorStateList) {
        this.f1337a.mo24766w(colorStateList);
        this.f1337a.mo24746b();
    }

    @hl3({hl3.C2354a.f13188c})
    public void setSupportCompoundDrawablesTintMode(@ts2 PorterDuff.Mode mode) {
        this.f1337a.mo24767x(mode);
        this.f1337a.mo24746b();
    }
