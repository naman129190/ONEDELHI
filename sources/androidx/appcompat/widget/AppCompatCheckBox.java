...
public class AppCompatCheckBox extends CheckBox implements df4, bf4, ps0, ef4 {

    /* renamed from: a */
    public final C1765b8 f1341a;

    /* renamed from: a */
    public final C2035e8 f1342a;

    /* renamed from: a */
    public C2610k8 f1343a;

    /* renamed from: a */
    public final C3569t8 f1344a;

    public AppCompatCheckBox(@mr2 Context context) {
        this(context, (AttributeSet) null);
    }

    public AppCompatCheckBox(@mr2 Context context, @ts2 AttributeSet attributeSet) {
        this(context, attributeSet, za3.C4057b.checkboxStyle);
    }

    public AppCompatCheckBox(@mr2 Context context, @ts2 AttributeSet attributeSet, int i) {
    ...
    public void drawableStateChanged() {
        ...
        C1765b8 b8Var = this.f1341a;
        if (b8Var != null) {
            b8Var.mo13520b();
        }
        C3569t8 t8Var = this.f1344a;
        if (t8Var != null) {
            t8Var.mo24746b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f1344a.mo24753j();
    }

    @ts2
    @hl3({hl3.C2354a.f13188c})
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f1344a.mo24754k();
    }
    ...
    public void setSupportCompoundDrawablesTintList(@ts2 ColorStateList colorStateList) {
        this.f1344a.mo24766w(colorStateList);
        this.f1344a.mo24746b();
    }

    @hl3({hl3.C2354a.f13188c})
    public void setSupportCompoundDrawablesTintMode(@ts2 PorterDuff.Mode mode) {
        this.f1344a.mo24767x(mode);
        this.f1344a.mo24746b();
    }
}
