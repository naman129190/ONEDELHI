...
public class AlertDialogLayout extends LinearLayoutCompat {
    public AlertDialogLayout(@ts2 Context context) {
        super(context);
    }

    public AlertDialogLayout(@ts2 Context context, @ts2 AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    /* renamed from: D */
    private void m2135D(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: E */
    public static int m2136E(View view) {
        int e0 = jt4.m18948e0(view);
        if (e0 > 0) {
            return e0;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m2136E(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: m */
    private void m2137m(int i, int i2) {
    ...
    /* renamed from: F */
    public final boolean mo1710F(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == za3.C4062g.topPanel) {
                    view = childAt;
                } else if (id == za3.C4062g.buttonPanel) {
                    view2 = childAt;
                } else if ((id != za3.C4062g.contentPanel && id != za3.C4062g.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r2 = r11
        L_0x007e:
            int r3 = com.onedelhi.secure.jt4.m18928Z(r17)
            int r2 = com.onedelhi.secure.ri1.m26762d(r2, r3)
            r2 = r2 & 7
            r3 = 1
