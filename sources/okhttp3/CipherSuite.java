...
@ii2(mo38103bv = {1, 0, 3}, mo38104d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0006\u0018\u0000 \b2\u00020\u0001:\u0001\bB\u000f\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\r\u0010\u0002\u001a\u00020\u0003H\u0007¢\u0006\u0002\b\u0006J\b\u0010\u0007\u001a\u00020\u0003H\u0016R\u0013\u0010\u0002\u001a\u00020\u00038\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u0002\u0010\u0005¨\u0006\t"}, mo38105d2 = {"Lokhttp3/CipherSuite;", "", "javaName", "", "(Ljava/lang/String;)V", "()Ljava/lang/String;", "-deprecated_javaName", "toString", "Companion", "okhttp"}, mo38106k = 1, mo38107mv = {1, 4, 0})
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        public final CipherSuite init(String str, int i) {
            CipherSuite cipherSuite = new CipherSuite(str, (wg0) null);
            CipherSuite.INSTANCES.put(str, cipherSuite);
            return cipherSuite;
        }

        private final String secondaryName(String str) {
            if (t54.m65466u2(str, "TLS_", false, 2, (Object) null)) {
                ...
                sb.append(substring);
                return sb.toString();
            } else if (!t54.m65466u2(str, "SSL_", false, 2, (Object) null)) {
                return str;
            } else {
        ...
        @zw1
        @vr2
        public final synchronized CipherSuite forJavaName(@vr2 String str) {
            ...
            if (cipherSuite == null) {
                ...
                if (cipherSuite == null) {
                    cipherSuite = new CipherSuite(str, (wg0) null);
                }
                CipherSuite.INSTANCES.put(str, cipherSuite);
            }
            return cipherSuite;
    ...
    static {
        Companion companion = new Companion((wg0) null);
        Companion = companion;
        ...
        TLS_RSA_WITH_AES_128_GCM_SHA256 = companion.init("TLS_RSA_WITH_AES_128_GCM_SHA256", Constants.ACTION_DELAY_PASSWORD_FOUND);
        TLS_RSA_WITH_AES_256_GCM_SHA384 = companion.init("TLS_RSA_WITH_AES_256_GCM_SHA384", Constants.ACTION_SAVE_CUST_ID);
        TLS_DHE_RSA_WITH_AES_128_GCM_SHA256 = companion.init("TLS_DHE_RSA_WITH_AES_128_GCM_SHA256", Constants.ACTION_INCORRECT_OTP);
        TLS_DHE_RSA_WITH_AES_256_GCM_SHA384 = companion.init("TLS_DHE_RSA_WITH_AES_256_GCM_SHA384", Constants.ACTION_NB_NEXT_BTN_CLICKED);
        TLS_DHE_DSS_WITH_AES_128_GCM_SHA256 = companion.init("TLS_DHE_DSS_WITH_AES_128_GCM_SHA256", 162);
        TLS_DHE_DSS_WITH_AES_256_GCM_SHA384 = companion.init("TLS_DHE_DSS_WITH_AES_256_GCM_SHA384", Constants.ACTION_NB_RESEND_CLICKED);
    ...
    public /* synthetic */ CipherSuite(String str, wg0 wg0) {
        this(str);
    }

    @zw1
    @vr2
    public static final synchronized CipherSuite forJavaName(@vr2 String str) {
    ...
    public final String m74773deprecated_javaName() {
