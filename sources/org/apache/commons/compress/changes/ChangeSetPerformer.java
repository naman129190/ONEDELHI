...
public class ChangeSetPerformer {
    ...
    public static class ArchiveInputStreamIterator implements ArchiveEntryIterator {
        ...
        /* renamed from: in */
        private final ArchiveInputStream f38878in;
        private ArchiveEntry next;

        public ArchiveInputStreamIterator(ArchiveInputStream archiveInputStream) {
            this.f38878in = archiveInputStream;
        }

        public InputStream getInputStream() {
            return this.f38878in;
        }

        public boolean hasNext() throws IOException {
            ArchiveEntry nextEntry = this.f38878in.getNextEntry();
            this.next = nextEntry;
