package org.apache.commons.compress.compressors.p008z;
...
public class ZCompressorInputStream extends LZWInputStream {
    ...
    public ZCompressorInputStream(InputStream inputStream) throws IOException {
        ...
        int readBits = (int) this.f38887in.readBits(8);
        int readBits2 = (int) this.f38887in.readBits(8);
        int readBits3 = (int) this.f38887in.readBits(8);
