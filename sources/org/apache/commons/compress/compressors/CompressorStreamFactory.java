...
import org.apache.commons.compress.compressors.p007xz.XZCompressorInputStream;
import org.apache.commons.compress.compressors.p007xz.XZCompressorOutputStream;
import org.apache.commons.compress.compressors.p007xz.XZUtils;
import org.apache.commons.compress.compressors.p008z.ZCompressorInputStream;
...
public class CompressorStreamFactory {
    ...
    /* renamed from: XZ */
    public static final String f38880XZ = "xz";

    /* renamed from: Z */
    public static final String f38881Z = "z";
    ...
    public CompressorInputStream createCompressorInputStream(String str, InputStream inputStream) throws CompressorException {
        ...
        try {
            ...
            if (f38880XZ.equalsIgnoreCase(str)) {
                return new XZCompressorInputStream(inputStream, this.decompressConcatenated);
            }
            ...
            if (f38881Z.equalsIgnoreCase(str)) {
                return new ZCompressorInputStream(inputStream);
            }
