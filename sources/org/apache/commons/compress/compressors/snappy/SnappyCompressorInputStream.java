...
public class SnappyCompressorInputStream extends CompressorInputStream {
    ...
    /* renamed from: in */
    private final InputStream f38891in;
            ...
            if (i2 == 1) {
                ...
                if (i < i2) {
                    ...
                    if (i > 0) {
                        ...
                        System.arraycopy(bArr4, i9 - i2, bArr4, i9, i);
                    }
                }
                this.writeIndex += i;
            }
    ...
    private boolean expandLiteral(int i) throws IOException {
        int readFully = IOUtils.readFully(this.f38891in, this.decompressBuf, this.writeIndex, i);
        count(readFully);
        if (i == readFully) {
    ...
    private void fill(int i) throws IOException {
        ...
        while (min > 0) {
            ...
            if (i4 == 0) {
                ...
                if (expandCopy(((long) ((readOneByte & 224) << 3)) | ((long) readOneByte()), i3)) {
                    return;
                }
            } else if (i4 == 2) {
                i3 = (readOneByte >> 2) + 1;
