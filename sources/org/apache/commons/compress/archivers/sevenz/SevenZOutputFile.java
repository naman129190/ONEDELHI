...
public class SevenZOutputFile implements Closeable {
    ...
    public static /* synthetic */ long access$414(SevenZOutputFile sevenZOutputFile, long j) {
    ...
    private void writePackInfo(DataOutput dataOutput) throws IOException {
        ...
        writeUint64(dataOutput, ((long) this.numNonEmptyStreams) & ZipConstants.ZIP64_MAGIC);
        dataOutput.write(9);
        for (SevenZArchiveEntry next : this.files) {
            if (next.hasStream()) {
    ...
    public void finish() throws IOException {
        if (!this.finished) {
            ...
            dataOutputStream2.writeLong(Long.reverseBytes(ZipConstants.ZIP64_MAGIC & ((long) byteArray.length)));
            crc322.reset();
