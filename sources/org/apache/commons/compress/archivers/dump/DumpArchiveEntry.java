...
public class DumpArchiveEntry implements ArchiveEntry {
    ...
    public DumpArchiveEntry(String str, String str2, int i, TYPE type2) {
        setType(type2);
        setName(str);
        this.simpleName = str2;
        this.ino = i;
    ...
    public static DumpArchiveEntry parse(byte[] bArr) {
        ...
        while (i < 512 && i < tapeSegmentHeader.count) {
            if (bArr[i + Constants.ACTION_NB_REMOVE_LOADER] == 0) {
                TapeSegmentHeader.access$408(tapeSegmentHeader);
            }
            i++;
        }
        System.arraycopy(bArr, Constants.ACTION_NB_REMOVE_LOADER, tapeSegmentHeader.cdata, 0, 512);
    ...
    public void update(byte[] bArr) {
        ...
        System.arraycopy(bArr, Constants.ACTION_NB_REMOVE_LOADER, this.header.cdata, 0, 512);
    }
}
