package org.apache.commons.compress.archivers.p006ar;
    ...
    public ArArchiveEntry getNextArEntry() throws IOException {
        ...
        if (IOUtils.readFully(this, bArr2) == asciiBytes2.length) {
            ...
            if (trim.endsWith("/")) {
                ...
                j = asLong;
                str = trim;
                ArArchiveEntry arArchiveEntry2 = new ArArchiveEntry(str, j, asInt, asInt(this.ID_BUF, true), asInt(this.FILE_MODE_BUF, 8), asLong(this.LAST_MODIFIED_BUF));
                this.currentEntry = arArchiveEntry2;
                return arArchiveEntry2;
            }
            j = asLong;
            str = bSDLongName;
            ArArchiveEntry arArchiveEntry22 = new ArArchiveEntry(str, j, asInt, asInt(this.ID_BUF, true), asInt(this.FILE_MODE_BUF, 8), asLong(this.LAST_MODIFIED_BUF));
