...
import org.apache.commons.compress.archivers.p006ar.ArArchiveInputStream;
import org.apache.commons.compress.archivers.p006ar.ArArchiveOutputStream;
...
public class ArchiveStreamFactory {
    ...
    /* renamed from: AR */
    public static final String f38863AR = "ar";
                        ...
                        try {
                            ...
                            try {
                                if (tarArchiveInputStream2.getNextTarEntry().isCheckSumOK()) {
                                    TarArchiveInputStream tarArchiveInputStream3 = new TarArchiveInputStream(inputStream, this.encoding);
    ...
    public ArchiveInputStream createArchiveInputStream(String str, InputStream inputStream) throws ArchiveException {
        ...
        } else if (f38863AR.equalsIgnoreCase(str)) {
            return new ArArchiveInputStream(inputStream);
        } else {
