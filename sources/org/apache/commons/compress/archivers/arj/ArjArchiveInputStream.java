...
public class ArjArchiveInputStream extends ArchiveInputStream {
    ...
    /* renamed from: in */
    private final DataInputStream f38864in;
    ...
    public ArjArchiveInputStream(InputStream inputStream, String str) throws ArchiveException {
        ...
        this.f38864in = new DataInputStream(inputStream);
        this.charsetName = str;
        try {
            MainHeader readMainHeader = readMainHeader();
            this.mainHeader = readMainHeader;
            int i = readMainHeader.arjFlags;
            if ((i & 1) != 0) {
    ...
    private byte[] readHeader() throws IOException {
        ...
        byte[] bArr = null;
        do {
            int read8 = read8(this.f38864in);
            while (true) {
                int read82 = read8(this.f38864in);
                if (read8 == 96 || read82 == ARJ_MAGIC_2) {
                    int read16 = read16(this.f38864in);
                } else {
                    read8 = read82;
                }
            }
            int read162 = read16(this.f38864in);
            if (read162 == 0) {
                return null;
            }
            if (read162 <= 2600) {
                bArr = new byte[read162];
                readFully(this.f38864in, bArr);
                long read32 = ((long) read32(this.f38864in)) & ZipConstants.ZIP64_MAGIC;
    ...
    private LocalFileHeader readLocalFileHeader() throws IOException {
        ...
        localFileHeader.compressedSize = ((long) read32(dataInputStream2)) & ZipConstants.ZIP64_MAGIC;
        localFileHeader.originalSize = ((long) read32(dataInputStream2)) & ZipConstants.ZIP64_MAGIC;
        localFileHeader.originalCrc32 = ((long) read32(dataInputStream2)) & ZipConstants.ZIP64_MAGIC;
    ...
    private MainHeader readMainHeader() throws IOException {
        ...
        if (readHeader != null) {
            ...
            mainHeader2.archiveSize = ((long) read32(dataInputStream2)) & ZipConstants.ZIP64_MAGIC;
            ...
            if (read16 > 0) {
                byte[] bArr2 = new byte[read16];
                mainHeader2.extendedHeaderBytes = bArr2;
                readFully(this.f38864in, bArr2);
                long read32 = ((long) read32(this.f38864in)) & ZipConstants.ZIP64_MAGIC;
                CRC32 crc32 = new CRC32();
    ...
    public ArjArchiveEntry getNextEntry() throws IOException {
        ...
        if (readLocalFileHeader != null) {
            BoundedInputStream boundedInputStream = new BoundedInputStream(this.f38864in, readLocalFileHeader.compressedSize);
            ...
            if (localFileHeader.method == 0) {
                this.currentInputStream = new CRC32VerifyingInputStream((InputStream) boundedInputStream, localFileHeader.originalSize, localFileHeader.originalCrc32);
            }
