...
import com.onedelhi.secure.xw4;
import java.io.File;
...
public class CpioArchiveOutputStream extends ArchiveOutputStream implements CpioConstants {
    ...
    private void writeNewEntry(CpioArchiveEntry cpioArchiveEntry) throws IOException {
        ...
        if (CpioConstants.CPIO_TRAILER.equals(cpioArchiveEntry.getName())) {
            ...
            this.nextArtificalDeviceAndInode = Math.max(this.nextArtificalDeviceAndInode, (C1655a7.C1658c.f8859a * deviceMin) + inode) + 1;
        }
    ...
    private void writeOldAsciiEntry(CpioArchiveEntry cpioArchiveEntry) throws IOException {
        ...
        if (CpioConstants.CPIO_TRAILER.equals(cpioArchiveEntry.getName())) {
            ...
            this.nextArtificalDeviceAndInode = Math.max(this.nextArtificalDeviceAndInode, (PlaybackStateCompat.f462y * device) + inode) + 1;
        }
    ...
    private void writeOldBinaryEntry(CpioArchiveEntry cpioArchiveEntry, boolean z) throws IOException {
        ...
        if (CpioConstants.CPIO_TRAILER.equals(cpioArchiveEntry.getName())) {
            ...
            long j = this.nextArtificalDeviceAndInode;
            long j2 = j & xw4.f37660c;
            this.nextArtificalDeviceAndInode = 1 + j;
            device = xw4.f37660c & (j >> 16);
            inode = j2;
        } else {
            this.nextArtificalDeviceAndInode = Math.max(this.nextArtificalDeviceAndInode, (PlaybackStateCompat.f458w * device) + inode) + 1;
        }
