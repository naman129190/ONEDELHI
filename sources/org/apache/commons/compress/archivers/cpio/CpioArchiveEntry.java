...
public class CpioArchiveEntry implements CpioConstants, ArchiveEntry {
    ...
    public long getMode() {
        return (this.mode != 0 || CpioConstants.CPIO_TRAILER.equals(this.name)) ? this.mode : PlaybackStateCompat.f456v;
    }
    ...
    public boolean isCharacterDevice() {
        return CpioUtil.fileType(this.mode) == PlaybackStateCompat.f452t;
    }
    ...
    public boolean isPipe() {
        return CpioUtil.fileType(this.mode) == PlaybackStateCompat.f450s;
    }

    public boolean isRegularFile() {
        return CpioUtil.fileType(this.mode) == PlaybackStateCompat.f456v;
    }
    ...
    public void setSize(long j) {
        if (j < 0 || j > ZipConstants.ZIP64_MAGIC) {
