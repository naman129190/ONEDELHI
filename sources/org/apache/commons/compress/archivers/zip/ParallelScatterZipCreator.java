...
public class ParallelScatterZipCreator {
    ...
    /* renamed from: es */
    private final ExecutorService f38871es;
    ...
    public static class DefaultBackingStoreSupplier implements ScatterGatherBackingStoreSupplier {
        ...
        public ScatterGatherBackingStore get() throws IOException {
            return new FileBasedScatterGatherBackingStore(File.createTempFile("parallelscatter", GoogleApiAvailabilityLight.TRACKING_SOURCE_NOTIFICATION + this.storeNum.incrementAndGet()));
        }
    }
    ...
    public final void submit(Callable<Object> callable) {
        this.futures.add(this.f38871es.submit(callable));
    }
    ...
    public void writeTo(ZipArchiveOutputStream zipArchiveOutputStream) throws IOException, InterruptedException, ExecutionException {
        ...
        this.f38871es.shutdown();
        this.f38871es.awaitTermination(jg3.f30769e, TimeUnit.SECONDS);
