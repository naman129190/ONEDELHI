...
import com.onedelhi.secure.C6794sw;
...
class Simple8BitZipEncoding implements ZipEncoding {
    ...
    public static final class Simple8BitChar implements Comparable<Simple8BitChar> {
        ...
        public String toString() {
            return "0x" + Integer.toHexString(this.unicode & C6794sw.f35206b) + "->0x" + Integer.toHexString(this.code & 255);
        }
    }
    ...
    public char decodeByte(byte b) {
        return b >= 0 ? (char) b : this.highChars[b + C7276xq.f37586a];
    }
