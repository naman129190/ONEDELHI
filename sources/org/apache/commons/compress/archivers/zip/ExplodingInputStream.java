...
class ExplodingInputStream extends InputStream {
    ...
    /* renamed from: in */
    private final InputStream f38869in;
    ...
    private void init() throws IOException {
        if (this.bits == null) {
            if (this.numberOfTrees == 3) {
                this.literalTree = BinaryTree.decode(this.f38869in, 256);
            }
            this.lengthTree = BinaryTree.decode(this.f38869in, 64);
            this.distanceTree = BinaryTree.decode(this.f38869in, 64);
            this.bits = new BitStream(this.f38869in);
        }
    }
