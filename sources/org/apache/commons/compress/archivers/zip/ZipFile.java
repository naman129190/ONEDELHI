...
public class ZipFile implements Closeable {
    ...
    public static /* synthetic */ class C76413 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.compress.archivers.zip.ZipFile.C76413.<clinit>():void");
        }
    }
    ...
    public static class Entry extends ZipArchiveEntry {
        ...
        public Entry(OffsetEntry offsetEntry2) {
    ...
    private InputStream getRawInputStream(ZipArchiveEntry zipArchiveEntry) {
    ...
    private void setSizesAndOffsetFromZip64Extra(ZipArchiveEntry zipArchiveEntry, OffsetEntry offsetEntry, int i) throws IOException {
        ...
        if (zip64ExtendedInformationExtraField != null) {
            boolean z = true;
            boolean z2 = zipArchiveEntry.getSize() == ZipConstants.ZIP64_MAGIC;
            boolean z3 = zipArchiveEntry.getCompressedSize() == ZipConstants.ZIP64_MAGIC;
            boolean z4 = offsetEntry.headerOffset == ZipConstants.ZIP64_MAGIC;
            if (i != 65535) {
                z = false;
            }
    ...
    public InputStream getInputStream(ZipArchiveEntry zipArchiveEntry) throws IOException, ZipException {
        ...
        int i = C76413.$SwitchMap$org$apache$commons$compress$archivers$zip$ZipMethod[ZipMethod.getMethodByCode(zipArchiveEntry.getMethod()).ordinal()];
        if (i == 1) {
